...
<%-- CSS 경로가 올바른지 확인해주세요 --%>
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/user/mentor/myPage/userMentoing/mentoringForm.css">
		...
		<main>
			...
			<div id="contentsMain">
				<div id="mentoringBackground">
					<form action="${pageContext.request.contextPath}/mentoringModifyOk.mo" method="post" enctype="multipart/form-data">
						<%-- 수정용 hidden 데이터 --%>
						<input type="hidden" name="mentoringNumber" value="${mentoring.mentoringNumber}">
						...
						<div id="mentoringMain">
							<div id="mentoring">
								<div id="mentoringTopics">
									<div class="subject">
										<label>학습 과목</label>
										<select name="mentoringSubject">
											<option value="JAVA" ${mentoring.mentoringSubject == 'JAVA' ? 'selected' : ''}>JAVA</option>
											<option value="Python" ${mentoring.mentoringSubject == 'Python' ? 'selected' : ''}>Python</option>
										</select>
									</div>
									<div class="title">
										<label>멘토링 제목</label>
										<input type="text" name="mentoringTitle" value="${mentoring.mentoringTitle}" required>
									</div>
									<div id="purpose">
										<label>수정할 목적</label>
								...
								<div id="curriculum">
									<div id="text">
										...
										<textarea id="mentoringCurriculum" name="mentoringCurriculum" required>${mentoring.curriculum}</textarea>
									</div>
									<div id="file">
										<div id="curriculumFileTitle">파일 수정 (기존: ${mentoring.fileName})</div>
							...
							<div id="profile">
								<a href="#">
									<img src="${pageContext.request.contextPath}/assets/img/user/userProfile/userIcon.png" alt="아이콘">
									<img id="profileImg" src="${pageContext.request.contextPath}/upload/${mentoring.profileImg}" 
										 onerror="this.src='${pageContext.request.contextPath}/assets/img/user/userProfile/ex1.png'" alt="프로필">
								</a>
							</div>
						</div>
						...
						<div id="buttons">
							...
							<button type="button" style="color: #475569;" onclick="history.back()">취소</button>
							<button type="button" id="delBtn" style="border-color: #ff4d4d; color: #ff4d4d;"
